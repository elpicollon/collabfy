...
export const initStore = (initialState = {}) => {
  const store = createStore(reducers(), initialState, applyMiddleware(thunk, sessionMiddleware, socketMiddleware, playbackMiddleware, devicesMiddleware, loggerMiddleware, searchMiddleware));
